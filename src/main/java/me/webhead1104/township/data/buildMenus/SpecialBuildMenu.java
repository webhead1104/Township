...
public class SpecialBuildMenu extends AbstractBuildMenu {
    private static final Map<Integer, List<BuildingType>> BUILDINGS = new HashMap<>();

    static {
        List<BuildingType> buildingTypes = new ArrayList<>(List.of(BuildingType.BARN, BuildingType.HELICOPTER, BuildingType.TRAIN, BuildingType.TOWN_HALL));
        int page = 0;
        int i = 0;
