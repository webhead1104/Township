...
public class FactoriesBuildMenu extends AbstractBuildMenu {
    private static final Map<Integer, List<BuildingType>> BUILDINGS = new HashMap<>();

    static {
        List<BuildingType> buildingTypes = new ArrayList<>(List.of(BuildingType.BAKERY, BuildingType.FEED_MILL, BuildingType.DAIRY_FACTORY, BuildingType.SUGAR_FACTORY, BuildingType.TEXTILE_FACTORY));
        int page = 0;
        int i = 0;
