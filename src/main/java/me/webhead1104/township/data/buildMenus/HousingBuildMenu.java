...
public class HousingBuildMenu extends AbstractBuildMenu {
    private static final Map<Integer, List<BuildingType>> BUILDINGS = new HashMap<>();

    static {
        List<BuildingType> buildingTypes = new ArrayList<>(List.of(BuildingType.COTTAGE, BuildingType.CAPE_COD_COTTAGE, BuildingType.CHALET_BUNGALOW, BuildingType.CONCH_HOUSE, BuildingType.BUNGALOW));
        int page = 0;
        int i = 0;
