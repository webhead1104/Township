...
public class FactoryTypeSuggestionResolver implements SuggestionResolver<BukkitSource> {

    private static final List<String> SUGGESTIONS = Arrays.stream(FactoryType.values()).map(Enum::name).toList();
