...
public class AnimalTypeArgument implements CustomArgumentType.Converted<AnimalType, String> {

    private static final List<AnimalType> TYPES = List.of(AnimalType.values());
