...
public class User {
    ...
    public User(UUID uuid) {
        ...
        Towncraft.logger.info("Finished creating a user in {} mills!", System.currentTimeMillis() - start);
    }
    ...
    public static User fromJson(String json) {
        try {
            ...
            if (version != user.getVersion()) {
                Towncraft.logger.info("Updated user from {} to {}", version, user.getVersion());
            }
            return user;
        } catch (Exception e) {
            Towncraft.logger.error("An error occurred whilst updating a user! Please report the following stacktrace to Webhead1104:", e);
        }
        throw new IllegalStateException("An error occurred whilst deserializing a user! Please report this to Webhead1104!");
    }
