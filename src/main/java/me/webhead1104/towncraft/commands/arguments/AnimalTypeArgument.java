...
public class AnimalTypeArgument implements CustomArgumentType.Converted<@NotNull Key, @NotNull String> {
    ...
    public <S> @NotNull CompletableFuture<Suggestions> listSuggestions(@NotNull CommandContext<S> context, SuggestionsBuilder builder) {
        Towncraft.getDataLoader(AnimalType.class).keys().forEach(animalKey -> {
