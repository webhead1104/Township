...
public class CommandUtils {
    public static boolean validate(int value, Player player) {
        return validate(0, Integer.MAX_VALUE, value, player);
    }

    public static boolean validate(int max, int value, Player player) {
        return validate(0, max, value, player);
    }

    public static boolean validate(int min, int max, int value, Player player) {
